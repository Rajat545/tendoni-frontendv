    ...
    <>
      ...
      <div className="mt-[25px]">
          ...
          <ul className="list-disc list-inside">
            ...
            <li>
              <strong>Website</strong> refers to Tendoni Group, accessible from
              <a href="https://tendonigroup.com/" className="text-blue-600 hover:underline">
                https://tendonigroup.com/
              </a>
            </li>
            <li>
          ...
          <h3 className="text-md font-semibold mt-4">Types of Data Collected</h3>
        ...
        <h4 className="text-md font-semibold mt-4">Use of Your Personal Data</h4>
        ...
        <h4 className="text-md font-semibold mt-4">We may share Your personal information in the following situations:</h4>
        <ul className="list-disc list-inside">
          <li>
        ...
        <h4 className="text-md font-semibold mt-4">Retention of Your Personal Data</h4>
        <p>
        ...
        <h4 className="text-md font-semibold mt-4">Transfer of Your Personal Data</h4>
        <p>
        ...
        <h4 className="text-md font-semibold mt-4">Delete Your Personal Data</h4>
        <p>
        ...
        <h4 className="text-md font-semibold mt-4">Disclosure of Your Personal Data</h4>
        ...
        <h4 className="text-md font-semibold mt-4">Security of Your Personal Data</h4>
        <p>
          The security of Your Personal Data is important to Us, but remember that no method of transmission over the Internet, or method of electronic storage is 100% secure. While We strive to use commercially acceptable means to protect Your Personal Data, We cannot guarantee its absolute security.
        </p>

        <h4 className="text-md font-semibold mt-4">Children's Privacy</h4>
        <p>
        ...
        <h4 className="text-md font-semibold mt-4">Links to Other Websites</h4>
        <p>
        ...
        <h4 className="text-md font-semibold mt-4">Changes to this Privacy Policy</h4>
        <p>
